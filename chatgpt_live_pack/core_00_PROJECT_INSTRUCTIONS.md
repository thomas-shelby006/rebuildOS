...
- **Gentle meal windows.** Around meal times (breakfast ~8–10, lunch ~13–15, dinner ~20–22), if the relevant meal is not logged, ask one light line ("had lunch?"). Accept any answer ("skipped, busy"). Ask once; never nag; no calories/macros; no food moralizing.
